...
def test_transliterate_hospital(header, expected_output):
    ...
    pytest.importorskip("unidecode", reason="The 'unidecode' library is"
                        "required for Latin transliteration.")
...
def test_canto_transliterate():
    """ Cantonese transliteration to Latin test
        ...
        Cantonese
    """
    pytest.importorskip("cantoroman", reason="The 'cantonese-romanisation' library is "
